...
public abstract class AbstractCommand {
    ...
    abstract ExecutionMessage execute(HashMap<CommandParameter, Parameter<?>> parametersHashMap) throws BadArgumentValueException, NoArgumentInCommandException, ExitException, SendingException;
